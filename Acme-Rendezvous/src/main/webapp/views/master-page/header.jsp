	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('USER')">
			<li><a class="fNiv"><spring:message	code="master.page.user" /></a>
				...
				<li><a href="comment/user/list.do"><spring:message code="master.page.comment.list" /></a></li>
			</li>
		</security:authorize>
		...
		<security:authorize access="isAuthenticated()">
			<li>
				...
				<ul>
					<li class="arrow"></li>
					<li><a href="actor/user/edit.do"><spring:message code="master.page.actorEdit" /></a></li>
